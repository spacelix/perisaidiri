<div id="drawer-units"
    ...
    <button type="button" data-drawer-hide="drawer-units" aria-controls="drawer-units"
    ...
    <form action="{{route('unit-ranting.store')}}" class="mb-6" method="POST">
        @csrf
        <div class="mb-6">
            ...
            <input type="text" id="name" name="name"
                   ...
                   placeholder="SMAN 1 CIKALONGWETAN">
            @error('name')
        ...
        <div class="mb-6">
            ...
            <textarea id="contact" rows="4" name="contact"
                      ...
                      placeholder="Email: sman1cikalongwetan@gmail.com No. HP / WA: 0811xx"></textarea>
            @error('contact')
        ...
        <div class="mb-6">
            ...
            <textarea id="sekretariat" rows="4" name="sekretariat"
                      class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="GOR DESA CIKALONG"></textarea>
            @error('sekretariat')
